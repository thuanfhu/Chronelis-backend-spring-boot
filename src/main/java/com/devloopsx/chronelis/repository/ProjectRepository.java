...
public interface ProjectRepository
  ...
  @Query(
      """
            ...
            """)
  Page<Project> findVisibleByWorkspaceIdAndUserId(
      @Param("workspaceId") Long workspaceId, @Param("userId") String userId, Pageable pageable);
  ...
  @Modifying
  @Query(
      "UPDATE Project p SET p.createdBy = :replacementUser WHERE p.createdBy.userId = :sourceUserId")
