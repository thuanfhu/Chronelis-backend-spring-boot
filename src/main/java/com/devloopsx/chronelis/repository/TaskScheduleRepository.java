...
public interface TaskScheduleRepository extends JpaRepository<TaskSchedule, Long> {
  ...
  @Modifying
  @Query(
      "UPDATE TaskSchedule ts SET ts.createdBy = :replacementUser WHERE ts.createdBy.userId = :sourceUserId")
  ...
  Page<TaskSchedule> findByTaskProjectIdAndScheduledDateBetween(
      Long projectId, LocalDate fromDate, LocalDate toDate, Pageable pageable);

  Page<TaskSchedule> findByTaskProjectWorkspaceIdAndScheduledDateBetween(
  ...
  @Query(
      """
                        ...
                        """)
  Page<TaskSchedule> findVisibleByWorkspaceCalendar(
  ...
  @Query(
      """
                        ...
                        """)
  List<TaskSchedule> findVisibleAssignedOpenSchedules(
      @Param("userId") String userId,
