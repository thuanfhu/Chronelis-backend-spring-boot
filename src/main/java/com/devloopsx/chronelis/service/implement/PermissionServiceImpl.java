...
public class PermissionServiceImpl implements PermissionService {
  ...
  public List<PermissionResponse> createModuleForPermissions(
    ...
    if (moduleExists) throw new ApplicationException(ErrorCode.PERMISSION_MODULE_NAME_EXISTED);
  ...
  public void deleteModuleByName(String moduleName) {
    ...
    if (!moduleExists) throw new ApplicationException(ErrorCode.PERMISSION_MODULE_NOT_FOUND);

    List<Permission> permissionsInModule =
  ...
  public PermissionResponse createPermission(CreatePermissionRequest createPermissionRequest) {
    this.permissionUtils.validateUniquePermissionOnCreate(
        createPermissionRequest.getName(),
        createPermissionRequest.getApiPath(),
        createPermissionRequest.getHttpMethod());
    ...
    Permission permission =
        this.permissionMapper.createPermissionRequestToPermission(createPermissionRequest);
  ...
  public PermissionResponse getPermissionById(String permissionId) {
    return this.permissionMapper.permissionToResponse(
        this.permissionRepository
  ...
  @Override
  public PaginationResponse getAllPermissionWithQuery(
    ...
    return PaginationResponse.builder()
        .meta(
            PaginationMeta.builder()
                ...
                .build())
        .content(
            this.permissionMapper.permissionsToPermissionResponseList(permissionPage.getContent()))
        .build();
  }

  @Override
  public PermissionResponse updatePermissionById(
    ...
    this.permissionUtils.validateUniquePermissionOnUpdate(
        permissionId, newName, newApiPath, newHttpMethod);

    this.permissionMapper.updatePermissionRequestToPermission(
        currentPermission, updatePermissionRequest);
