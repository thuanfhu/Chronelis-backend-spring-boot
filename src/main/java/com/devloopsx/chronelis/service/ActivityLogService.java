...
public interface ActivityLogService {
    PaginationResponse listByWorkspace(Long workspaceId, String actorId, ActivityActionType actionType,
            ActivityTargetType targetType, LocalDateTime fromDateTime, LocalDateTime toDateTime, Pageable pageable);

    void createLog(Long workspaceId, String actorId, ActivityActionType actionType, ActivityTargetType targetType,
