...
public final class CacheKeys {
    ...
    public static String projectCalendar(Long projectId, String fromDate, String toDate, int page, int size,
            long scheduleVersion) {
        return "calendar:project:%d:from:%s:to:%s:page:%d:size:%d:v%d"
                .formatted(projectId, fromDate, toDate, page, size, scheduleVersion);
    }

    public static String workspaceCalendar(Long workspaceId, String userId, String fromDate, String toDate, int page,
            int size, long scheduleVersion, long accessVersion) {
        return "calendar:workspace:%d:user:%s:from:%s:to:%s:page:%d:size:%d:scheduleV%d:accessV%d"
                .formatted(workspaceId, userId, fromDate, toDate, page, size, scheduleVersion, accessVersion);
    }
