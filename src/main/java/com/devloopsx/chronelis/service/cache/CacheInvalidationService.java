...
public class CacheInvalidationService {
    ...
    public void invalidateGlobalAuthzAfterCommit() {
        afterCommitExecutor.runAfterCommit(() -> redisCacheService.incrementVersion(CacheKeys.VERSION_AUTHZ_GLOBAL));
    }
    ...
    public void invalidateProjectAccessAfterCommit(Long projectId) {
        ...
        afterCommitExecutor.runAfterCommit(() -> redisCacheService.incrementVersion(CacheKeys.projectAccessVersion(projectId)));
    }
    ...
    public void invalidateWorkspaceAccessAfterCommit(Long workspaceId) {
        ...
        afterCommitExecutor.runAfterCommit(() -> {
            ...
            workspaceMemberRepository.findByWorkspaceIdOrderByJoinedAtAsc(workspaceId).stream()
                    ...
                    .forEach(userId -> redisCacheService.incrementVersion(CacheKeys.userWorkVersion(userId)));
        });
    }
    ...
    public void invalidateUserWorkAfterCommit(String userId) {
        ...
        afterCommitExecutor.runAfterCommit(() -> redisCacheService.incrementVersion(CacheKeys.userWorkVersion(userId)));
    }
    ...
    public void invalidateUserWorkAfterCommit(Collection<String> userIds) {
        ...
        afterCommitExecutor.runAfterCommit(() -> userIds.stream()
    ...
    public void invalidateProjectTasksAfterCommit(Long projectId) {
        ...
        afterCommitExecutor.runAfterCommit(() -> redisCacheService.incrementVersion(CacheKeys.projectTasksVersion(projectId)));
    }
    ...
    public void invalidateProjectSchedulesAfterCommit(Long projectId) {
        ...
        afterCommitExecutor.runAfterCommit(() -> redisCacheService.incrementVersion(CacheKeys.projectSchedulesVersion(projectId)));
    }
    ...
    public void invalidateWorkspaceSchedulesAfterCommit(Long workspaceId) {
        ...
        afterCommitExecutor.runAfterCommit(() -> redisCacheService.incrementVersion(CacheKeys.workspaceSchedulesVersion(workspaceId)));
    }
}
