...
public interface UserMapper {
  ...
  void updateUserProfileRequestToUser(
      @MappingTarget User user, UpdateUserProfileRequest updateUserProfileRequest);
  ...
  @Mapping(target = "version", ignore = true)
  @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
  void updateUserForAdminRequestToUser(
      @MappingTarget User user, UpdateUserForAdminRequest updateUserForAdminRequest);
}
