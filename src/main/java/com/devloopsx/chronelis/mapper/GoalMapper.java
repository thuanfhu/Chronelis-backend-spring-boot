...
public interface GoalMapper {
    ...
    @Mapping(target = "managerTeamId", expression = "java(goal.getManagerTeam() != null ? goal.getManagerTeam().getId() : null)")
    @Mapping(target = "managerTeamName", expression = "java(goal.getManagerTeam() != null ? goal.getManagerTeam().getName() : null)")
