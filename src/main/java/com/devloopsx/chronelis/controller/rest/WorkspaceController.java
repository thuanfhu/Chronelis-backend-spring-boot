...
public class WorkspaceController {
  ...
  ApiResponse<WorkspaceResponse> createWorkspace(
      @RequestBody @Valid CreateWorkspaceRequest request, HttpServletRequest servletRequest) {
  ...
  ApiResponse<WorkspaceResponse> getWorkspace(
  ...
  @GetMapping
  ApiResponse<PaginationResponse> listVisibleWorkspaces(
  ...
  ApiResponse<WorkspaceMemberResponse> addMember(
      @PathVariable Long workspaceId,
  ...
  ApiResponse<List<WorkspaceMemberResponse>> listMembers(
      @PathVariable Long workspaceId, HttpServletRequest servletRequest) {
  ...
  ApiResponse<WorkspaceMemberResponse> updateMemberRole(
      @PathVariable Long workspaceId,
  ...
  ApiResponse<Void> deleteWorkspace(
      @PathVariable Long workspaceId, HttpServletRequest servletRequest) {
