...
public class PermissionController {
  ...
  ApiResponse<List<PermissionResponse>> createModuleForPermissions(
      @RequestBody @Valid CreateModuleRequest createModuleRequest,
  ...
  ApiResponse<Void> deleteModuleByName(
      @PathVariable("name") String moduleName, HttpServletRequest servletRequest) {
  ...
  ApiResponse<PermissionResponse> getPermissionById(
      @PathVariable String permissionId, HttpServletRequest servletRequest) {
    return ApiResponse.<PermissionResponse>builder()
  ...
  @GetMapping
  ApiResponse<PaginationResponse> getAllPermissionWithQuery(
  ...
  ApiResponse<Void> deletePermissionById(
      @PathVariable String permissionId, HttpServletRequest servletRequest) {
