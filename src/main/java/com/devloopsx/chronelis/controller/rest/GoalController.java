...
public class GoalController {
  ...
  @PostMapping
  ApiResponse<GoalResponse> createGoal(
      @RequestBody @Valid CreateGoalRequest request, HttpServletRequest servletRequest) {
  ...
  ApiResponse<PaginationResponse> listGoalsByProject(
