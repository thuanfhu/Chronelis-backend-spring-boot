...
public class TaskController {
        ...
        ApiResponse<TaskDependencyDetailsResponse> getTaskDependencies(@PathVariable Long taskId,
                        HttpServletRequest servletRequest) {
        ...
        ApiResponse<TaskDependencyDetailsResponse> updateTaskDependencies(@PathVariable Long taskId,
