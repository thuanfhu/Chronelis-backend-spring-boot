...
public class TaskController {
  ...
  ApiResponse<TaskResponse> createTask(
      @RequestBody @Valid CreateTaskRequest request, HttpServletRequest servletRequest) {
  ...
  @GetMapping("/my-work")
  ApiResponse<MyWorkResponse> getMyWork(HttpServletRequest servletRequest) {
  ...
  ApiResponse<TaskDependencyDetailsResponse> getTaskDependencies(
      @PathVariable Long taskId, HttpServletRequest servletRequest) {
    return ApiResponse.<TaskDependencyDetailsResponse>builder()
  ...
  ApiResponse<TaskDependencyDetailsResponse> updateTaskDependencies(
      @PathVariable Long taskId,
      @RequestBody @Valid UpdateTaskDependenciesRequest request,
      HttpServletRequest servletRequest) {
    return ApiResponse.<TaskDependencyDetailsResponse>builder()
        .message("Cập nhật phụ thuộc task thành công")
        .data(taskDependencyService.updateDependencies(taskId, request))
        .meta(buildMetaInfo(servletRequest))
        .build();
  }

  @GetMapping("/project/{projectId}")
  ApiResponse<PaginationResponse> listTasksByProject(
      @PathVariable Long projectId, Pageable pageable, HttpServletRequest servletRequest) {
  ...
  ApiResponse<PaginationResponse> listTasksByGoal(
      @PathVariable Long goalId, Pageable pageable, HttpServletRequest servletRequest) {
    return ApiResponse.<PaginationResponse>builder()
  ...
  ApiResponse<TaskResponse> reorderTask(
      @PathVariable Long taskId,
  ...
  ApiResponse<TaskResponse> updateCompletion(
      @PathVariable Long taskId,
