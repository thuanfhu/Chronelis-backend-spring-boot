...
public class WorkspaceTeamController {
    ...
    @PostMapping
    ApiResponse<WorkspaceTeamResponse> createTeam(@RequestBody @Valid CreateWorkspaceTeamRequest request,
    ...
    @PatchMapping("/{teamId}")
    ApiResponse<WorkspaceTeamResponse> updateTeam(@PathVariable Long teamId,
    ...
    @GetMapping("/{teamId}")
    ApiResponse<WorkspaceTeamResponse> getTeam(@PathVariable Long teamId,
            HttpServletRequest servletRequest) {
        return ApiResponse.<WorkspaceTeamResponse>builder()
    ...
    ApiResponse<List<WorkspaceTeamResponse>> listByWorkspace(@PathVariable Long workspaceId,
            HttpServletRequest servletRequest) {
    ...
    ApiResponse<WorkspaceTeamMemberResponse> addMember(@PathVariable Long teamId,
    ...
    ApiResponse<Void> removeMember(@PathVariable Long teamId, @PathVariable String userId,
            HttpServletRequest servletRequest) {
    ...
    ApiResponse<List<WorkspaceTeamMemberResponse>> listMembers(@PathVariable Long teamId,
            HttpServletRequest servletRequest) {
