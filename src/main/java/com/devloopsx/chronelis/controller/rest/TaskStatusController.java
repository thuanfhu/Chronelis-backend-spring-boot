...
public class TaskStatusController {
  ...
  @PostMapping
  ApiResponse<TaskStatusResponse> createStatus(
      @RequestBody @Valid CreateTaskStatusRequest request, HttpServletRequest servletRequest) {
  ...
  ApiResponse<List<TaskStatusResponse>> listByProject(
  ...
  ApiResponse<TaskStatusResponse> updateStatus(
  ...
  ApiResponse<List<TaskStatusResponse>> reorderStatuses(
