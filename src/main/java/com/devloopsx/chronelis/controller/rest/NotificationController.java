...
public class NotificationController {
    ...
    @GetMapping
    ApiResponse<PaginationResponse> listMyNotifications(Pageable pageable, HttpServletRequest servletRequest) {
    ...
    ApiResponse<Void> markOneAsRead(@PathVariable Long notificationId, HttpServletRequest servletRequest) {
