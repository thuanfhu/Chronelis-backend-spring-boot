...
public class UserController {
  ...
  ApiResponse<Void> updateUserEmail(
  ...
  @GetMapping
  ApiResponse<PaginationResponse> getAllUserWithQuery(
      @Filter Specification<User> spec, Pageable pageable, HttpServletRequest servletRequest) {
  ...
  @GetMapping("/{userId}")
  ApiResponse<UserSecureResponse> getUserById(
      @PathVariable String userId, HttpServletRequest servletRequest) {
    return ApiResponse.<UserSecureResponse>builder()
  ...
  ApiResponse<Void> deleteRoleFromUser(
      @PathVariable String userId,
      @RequestBody DeleteRoleFromUserRequest deleteRoleFromUserRequest,
      HttpServletRequest servletRequest) {
  ...
  ApiResponse<UserSecureResponse> becomeStaff(HttpServletRequest servletRequest) {
    return ApiResponse.<UserSecureResponse>builder()
        .message("Nâng cấp thành công sang vai trò STAFF")
        .data(userService.becomeStaff())
        .meta(buildMetaInfo(servletRequest))
        .build();
  }
}
