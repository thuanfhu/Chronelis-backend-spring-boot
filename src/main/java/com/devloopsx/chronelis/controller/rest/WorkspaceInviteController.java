...
public class WorkspaceInviteController {
    ...
    @PostMapping
    ApiResponse<WorkspaceInviteResponse> createInvite(@RequestBody @Valid CreateWorkspaceInviteRequest request,
    ...
    ApiResponse<List<WorkspaceInviteResponse>> listActiveInvites(@PathVariable Long workspaceId,
            HttpServletRequest servletRequest) {
    ...
    ApiResponse<WorkspaceInviteResponse> validateInviteCode(@PathVariable String inviteCode,
            HttpServletRequest servletRequest) {
        return ApiResponse.<WorkspaceInviteResponse>builder()
    ...
    @PostMapping("/join")
    ApiResponse<Void> joinByInvite(@RequestBody @Valid JoinByInviteRequest request,
            HttpServletRequest servletRequest) {
