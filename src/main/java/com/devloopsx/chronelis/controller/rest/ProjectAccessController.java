...
public class ProjectAccessController {
  ...
  @GetMapping
  ApiResponse<List<ProjectAccessResponse>> listProjectAccess(
  ...
  @GetMapping("/me")
  ApiResponse<EffectiveProjectAccessResponse> getCurrentUserEffectiveAccess(
      @PathVariable Long projectId, HttpServletRequest servletRequest) {
  ...
  @PostMapping
  ApiResponse<ProjectAccessResponse> upsertProjectAccess(
  ...
  ApiResponse<ProjectAccessResponse> updateProjectAccess(
      @PathVariable Long projectId,
  ...
  ApiResponse<Void> revokeProjectAccess(
      @PathVariable Long projectId,
      @PathVariable Long accessId,
      HttpServletRequest servletRequest) {
