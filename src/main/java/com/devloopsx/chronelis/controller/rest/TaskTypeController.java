...
public class TaskTypeController {
  ...
  @PostMapping
  ApiResponse<TaskTypeResponse> createTaskType(
      @RequestBody @Valid CreateTaskTypeRequest request, HttpServletRequest servletRequest) {
  ...
  ApiResponse<TaskTypeResponse> updateTaskType(
  ...
  ApiResponse<TaskTypeResponse> getTaskType(
      @PathVariable Long taskTypeId, HttpServletRequest servletRequest) {
    return ApiResponse.<TaskTypeResponse>builder()
  ...
  ApiResponse<List<TaskTypeResponse>> listByProject(
  ...
  ApiResponse<Void> deleteTaskType(
      @PathVariable Long taskTypeId, HttpServletRequest servletRequest) {
