...
public class ProjectController {
        ...
        @PostMapping
        ApiResponse<ProjectResponse> createProject(@RequestBody @Valid CreateProjectRequest request,
        ...
        ApiResponse<ProjectResponse> updateProject(@PathVariable Long projectId,
        ...
        ApiResponse<ProjectResponse> updateProjectStatus(@PathVariable Long projectId,
        ...
        ApiResponse<ProjectResponse> getProject(@PathVariable Long projectId, HttpServletRequest servletRequest) {
                return ApiResponse.<ProjectResponse>builder()
        ...
        ApiResponse<PaginationResponse> listProjectsByWorkspace(@PathVariable Long workspaceId, Pageable pageable,
                        HttpServletRequest servletRequest) {
