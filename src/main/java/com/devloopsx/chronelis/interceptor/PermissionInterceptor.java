...
public class PermissionInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(final HttpServletRequest request, final HttpServletResponse response, final Object handler)
		...
		Set<String> routePermissions = authzPermissionCacheService.getUserRoutePermissions(userAuthenticated);

		boolean isAuthorized = routePermissions.stream()
				.anyMatch(permissionRoute -> authzPermissionCacheService.routeMatches(permissionRoute, httpMethod,
						apiPath));
		if (!isAuthorized)
