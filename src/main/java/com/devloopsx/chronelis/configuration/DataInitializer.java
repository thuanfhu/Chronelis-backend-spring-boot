...
public class DataInitializer implements ApplicationRunner {
  ...
  private void initializePermissions(List<Permission> permissions) {
    ...
    for (Permission p : permissions) {
      var existingOpt =
          permissionRepository.findByApiPathAndHttpMethod(p.getApiPath(), p.getHttpMethod());
      if (existingOpt.isPresent()) {
        Permission existing = existingOpt.get();
        if (!existing.getModule().equals(p.getModule())
            || !existing.getName().equals(p.getName())) {
    ...
    transactionTemplate.executeWithoutResult(
        status -> {
          ...
          for (Map.Entry<RoleType, List<Permission>> entry : roles.entrySet()) {
            ...
            Role role =
                roleRepository
                    .findByName(entry.getKey().getName())
  ...
  private List<Permission> getDefaultPermissions() {
    return List.of(
        ...
        new Permission(
            "Verify account via email", "/api/v1/auth/verify-active-account", "POST", "AUTH"),
        ...
        new Permission(
            "Verify and update new email", "/api/v1/users/verify-change-email", "POST", "USER"),
        new Permission("Retrieve user account details", "/api/v1/users/{userId}", "GET", "USER"),
        new Permission(
            "Retrieve all user accounts with query parameters", "/api/v1/users", "GET", "USER"),
        new Permission(
            "Update user account information (admin)", "/api/v1/users/{userId}", "PATCH", "USER"),
        ...
        new Permission(
            "Update role information (including adding permissions)",
            "/api/v1/roles/{roleId}",
            "PATCH",
            "ROLE"),
        ...
        new Permission(
            "Delete a module by name", "/api/v1/permissions/module/{name}", "DELETE", "PERMISSION"),
        new Permission(
            "Retrieve all module names", "/api/v1/permissions/modules", "GET", "PERMISSION"),
        ...
        new Permission(
            ...
            "PERMISSION"),
        new Permission(
            "Retrieve all permissions with query parameters",
            "/api/v1/permissions",
            "GET",
            "PERMISSION"),
        new Permission(
            "Delete a permission", "/api/v1/permissions/{permissionId}", "DELETE", "PERMISSION"),

        // Module Files (Azure Blob)
        new Permission(
            "Upload a file to Azure Blob",
            "/api/v1/storage/azure-blob/upload/single",
            "POST",
            "STORAGE"),
        new Permission(
            "Upload multiple files to Azure Blob",
            "/api/v1/storage/azure-blob/upload/multiple",
            "POST",
            "STORAGE"),
        new Permission(
            "Delete a file on Azure Blob",
            "/api/v1/storage/azure-blob/delete/single",
            "DELETE",
            "STORAGE"),
        new Permission(
            "Delete multiple files on Azure Blob",
            "/api/v1/storage/azure-blob/delete/multiple",
            "DELETE",
            "STORAGE"),
        new Permission(
            "Move a file from one folder to another",
            "/api/v1/storage/azure-blob/move/single",
            "PUT",
            "STORAGE"),
        new Permission(
            "Move multiple files from various folders to a new folder",
            "/api/v1/storage/azure-blob/move/multiple",
            "PUT",
            "STORAGE"),
        ...
        new Permission(
            "Update a workspace", "/api/v1/workspaces/{workspaceId}", "PATCH", "WORKSPACE"),
        new Permission(
            "Delete a workspace", "/api/v1/workspaces/{workspaceId}", "DELETE", "WORKSPACE"),
        new Permission(
            "Get workspace detail", "/api/v1/workspaces/{workspaceId}", "GET", "WORKSPACE"),
        ...
        new Permission(
            "Update project status", "/api/v1/projects/{projectId}/status", "PATCH", "PROJECT"),
        ...
        new Permission(
            ...
            "PROJECT"),
        new Permission(
            "Get project analytics", "/api/v1/projects/{projectId}/analytics", "GET", "PROJECT"),

        // Module Project Access
        new Permission(
            "List project access", "/api/v1/projects/{projectId}/access", "GET", "PROJECT_ACCESS"),
        new Permission(
            "Upsert project access",
            "/api/v1/projects/{projectId}/access",
            "POST",
            "PROJECT_ACCESS"),
        new Permission(
            "Update project access",
            "/api/v1/projects/{projectId}/access/{accessId}",
            "PATCH",
            "PROJECT_ACCESS"),
        new Permission(
            ...
            "PROJECT_ACCESS"),
        new Permission(
            "Get effective project access",
            "/api/v1/projects/{projectId}/access/me",
            "GET",
            "PROJECT_ACCESS"),
        ...
        new Permission(
            "Retrieve task dependencies", "/api/v1/tasks/{taskId}/dependencies", "GET", "TASK"),
        new Permission(
            "Update task dependencies", "/api/v1/tasks/{taskId}/dependencies", "PUT", "TASK"),
        ...
        new Permission(
            "List statuses by project",
            "/api/v1/task-statuses/project/{projectId}",
            "GET",
            "TASK_STATUS"),
        new Permission(
            "Update task status", "/api/v1/task-statuses/{statusId}", "PATCH", "TASK_STATUS"),
        new Permission(
            "Reorder statuses",
            "/api/v1/task-statuses/project/{projectId}/reorder",
            "PATCH",
            "TASK_STATUS"),
        new Permission(
            "Delete task status", "/api/v1/task-statuses/{statusId}", "DELETE", "TASK_STATUS"),

        // Module Task Schedules
        new Permission("Create task schedule", "/api/v1/task-schedules", "POST", "TASK_SCHEDULE"),
        new Permission(
            "Update task schedule",
            "/api/v1/task-schedules/{scheduleId}",
            "PATCH",
            "TASK_SCHEDULE"),
        new Permission(
            ...
            "TASK_SCHEDULE"),
        new Permission(
            "List schedules by task",
            "/api/v1/task-schedules/task/{taskId}",
            "GET",
            "TASK_SCHEDULE"),
        new Permission(
            "Calendar by project",
            "/api/v1/task-schedules/calendar/project/{projectId}",
            "GET",
            "TASK_SCHEDULE"),
        new Permission(
            "Calendar by workspace",
            "/api/v1/task-schedules/calendar/workspace/{workspaceId}",
            "GET",
            "TASK_SCHEDULE"),
        ...
        new Permission(
            "Update task comment", "/api/v1/task-comments/{commentId}", "PATCH", "TASK_COMMENT"),
        new Permission(
            "Delete task comment", "/api/v1/task-comments/{commentId}", "DELETE", "TASK_COMMENT"),
        new Permission(
            "List comments by task", "/api/v1/task-comments/task/{taskId}", "GET", "TASK_COMMENT"),
        ...
        new Permission(
            "List activity logs by workspace",
            "/api/v1/activity-logs/workspace/{workspaceId}",
            "GET",
            "ACTIVITY_LOG"),
        ...
        new Permission(
            "Update a task type", "/api/v1/task-types/{taskTypeId}", "PATCH", "TASK_TYPE"),
        new Permission(
            "Get task type detail", "/api/v1/task-types/{taskTypeId}", "GET", "TASK_TYPE"),
        new Permission(
            "List task types by project",
            "/api/v1/task-types/project/{projectId}",
            "GET",
            "TASK_TYPE"),
        new Permission(
            "Delete a task type", "/api/v1/task-types/{taskTypeId}", "DELETE", "TASK_TYPE"),

        // Module Workspace Teams
        new Permission(
            "Create a workspace team", "/api/v1/workspace-teams", "POST", "WORKSPACE_TEAM"),
        new Permission(
            ...
            "WORKSPACE_TEAM"),
        new Permission(
            "Get workspace team detail",
            "/api/v1/workspace-teams/{teamId}",
            "GET",
            "WORKSPACE_TEAM"),
        new Permission(
            "List teams by workspace",
            "/api/v1/workspace-teams/workspace/{workspaceId}",
            "GET",
            "WORKSPACE_TEAM"),
        new Permission(
        ...
        new Permission(
            "Add member to team",
            "/api/v1/workspace-teams/{teamId}/members",
            "POST",
            "WORKSPACE_TEAM"),
        new Permission(
            "Remove member from team",
            "/api/v1/workspace-teams/{teamId}/members/{userId}",
            "DELETE",
            "WORKSPACE_TEAM"),
        new Permission(
            "List team members",
        ...
        new Permission(
            ...
            "WORKSPACE_INVITE"),
        new Permission(
            "List active workspace invites",
            "/api/v1/workspace-invites/workspace/{workspaceId}",
            "GET",
            "WORKSPACE_INVITE"),
        new Permission(
            "Revoke workspace invite",
            "/api/v1/workspace-invites/{inviteId}/revoke",
            "PATCH",
            "WORKSPACE_INVITE"),
        new Permission(
            "Validate invite code",
            "/api/v1/workspace-invites/validate/{inviteCode}",
            "GET",
            "WORKSPACE_INVITE"),
        new Permission(
            "Join workspace by invite code",
            "/api/v1/workspace-invites/join",
            "POST",
            "WORKSPACE_INVITE"),
        ...
        // Module Pomodoro
        new Permission(
            "Save Pomodoro session", "/api/v1/pomodoro/tasks/{taskId}", "POST", "POMODORO"),
        new Permission(
            "Get Pomodoro sessions", "/api/v1/pomodoro/tasks/{taskId}", "GET", "POMODORO"));
  }

  private Map<RoleType, List<Permission>> getDefaultRoles() {
    // Get all permissions of modules
    List<Permission> moduleAuthAllPermissions =
        permissionRepository
            .findByModule("AUTH")
            ...
            List.of(
                ...
                List.of(
                    ...
                    findPermissionOrThrow(
                        "/api/v1/workspaces/{workspaceId}/members/{userId}/role", "PATCH"),
                    ...
                    findPermissionOrThrow(
                        "/api/v1/projects/{projectId}/access/{accessId}", "PATCH"),
                    findPermissionOrThrow(
                        "/api/v1/projects/{projectId}/access/{accessId}", "DELETE"),
                    findPermissionOrThrow("/api/v1/projects/{projectId}/access/me", "GET"),
                    ...
                    findPermissionOrThrow(
                        "/api/v1/task-statuses/project/{projectId}/reorder", "PATCH"),
                    ...
                    findPermissionOrThrow(
                        "/api/v1/workspace-teams/{teamId}/members/{userId}", "DELETE"),
                    ...
                    findPermissionOrThrow(
                        "/api/v1/workspace-invites/workspace/{workspaceId}", "GET"),
                    findPermissionOrThrow(
                        "/api/v1/workspace-invites/{inviteId}/revoke", "PATCH"))));
  ...
  private Permission findPermissionOrThrow(String apiPath, String httpMethod) {
    return permissionRepository
        .findByApiPathAndHttpMethod(apiPath, httpMethod)
